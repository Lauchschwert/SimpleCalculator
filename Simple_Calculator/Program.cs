...
namespace Simple_Calculator
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // code
            Console
                .WriteLine("(If you want to Substract 2 Numbers, remember that your first number must be higher than the second number.)\n");
            ...
            Console
                .WriteLine("What do you want to do with your numbers? (Divide: D / Add: A / Subtract: S / Multiply: M)\n"); // asks you what you want to do with the two numbers
